...
const { templateParser, templatePlugin, tsPlugin, processInlineTemplates } = require('angular-eslint');
const checkFilePlugin = require('eslint-plugin-check-file');
const importPlugin = require('eslint-plugin-import');
const { parser, plugin } = require('typescript-eslint');
const { default: nPlugin } = require('eslint-plugin-n');
const jsdocPlugin = require('eslint-plugin-jsdoc');
const { default: unicornPlugin } = require('eslint-plugin-unicorn');
const rxjsAngularPlugin = require('eslint-plugin-rxjs-angular-x');
...
module.exports = defineConfig([
    {
        ...
        plugins: { 'check-file': checkFilePlugin, 'import': importPlugin, 'node': nPlugin, 'unicorn': unicornPlugin },
        rules: {
            ...
            '@typescript-eslint/no-restricted-types': [
                'error',
                {
                    types: {
                        ...
                        OpaqueToken: { message: 'Avoid using the `OpaqueToken` type. Prefer the `InjectionToken` instead.' },
